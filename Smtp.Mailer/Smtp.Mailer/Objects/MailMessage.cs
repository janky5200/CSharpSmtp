...
namespace Smtp.Mailer.Objects
{
    public class MailMessage
    {
        ...
        public List<MailAttchment> Attachment { get; set; }
        ...
        public MailMessage()
        {
            ...
            Attachment = new List<MailAttchment>();
        ...
        public MailMessage(MailAccount from, MailAccount to, string content)
            : this()
        {
            this.From = from;
            this.Tos.Add(to);
        ...
        public void AddAttachment(string fileName, string contentID)
        {
            this.Attachment.Add(new MailAttchment() { FileName = fileName, ContentID = contentID });
        }
        /// <summary>
        /// 添加附件
        /// </summary>
        ...
        {
            this.Attachment.Add(new MailAttchment() { FileName = fileName });
        }
        /// <summary>
        /// 添加密送人
        /// </summary>
